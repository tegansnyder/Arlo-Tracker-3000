...
<div class="gridster">
    <ul>
	    ...
	    <li data-row="3" data-col="1" data-sizex="" data-sizey="1" class="box-day-chart">
	    	<h1>Today</h1>
	    ...
	    <li data-row="3" data-col="3" data-sizex="" data-sizey="1">
	    	<button type="button" onclick="window.location='/';" class="btn btn-lg btn-primary">
